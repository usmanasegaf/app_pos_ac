    ...
    Future<void> _finalizeTransaction() async {
        ...
        try {
            ...
            // Pastikan history di-refresh setelah berhasil menyimpan transaksi
            await Future.delayed(Duration.zero); // Beri jeda kecil untuk komit DB
            ...
            // --- BARIS-BARIS BERIKUT DIHAPUS AGAR TIDAK DI-0-KAN ---
